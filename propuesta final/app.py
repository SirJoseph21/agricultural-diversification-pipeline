...
with tab2:
    ...
    cultivos_fin_graf = cultivos_fin + ["Maíz grano"]

    df_fin_graf = pd.DataFrame([
        {
            "cultivo": c,
            "ingreso": datos_financieros[c]["precio_ton"] * datos_financieros[c]["rendimiento"],
            "costo":   datos_financieros[c]["costo_ha"],
        ...
        for c in cultivos_fin_graf if c in datos_financieros
    ])
